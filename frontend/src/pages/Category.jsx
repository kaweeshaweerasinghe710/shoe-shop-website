...
const Category = () => {
  ...
  const loadCategory = async () => {
    try {
      const res = await fetch(`fantastic-abundance-production.up.railway.app/api/products?category=${slug}`);
  ...
  const loadAllCategories = async () => {
    try {
      const res = await fetch("fantastic-abundance-production.up.railway.app/api/products");
      const data = await res.json();
