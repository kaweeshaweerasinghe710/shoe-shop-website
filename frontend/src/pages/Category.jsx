...
const Category = () => {
  ...
  const loadCategory = async () => {
    try {
      const res = await fetch(`https://shoe-shop-website-m48s.vercel.app/api/products?category=${slug}`);
  ...
  const loadAllCategories = async () => {
    try {
      const res = await fetch("https://shoe-shop-website-m48s.vercel.app/api/products");
      const data = await res.json();
